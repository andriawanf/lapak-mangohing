            ...
            <div class="px-4 mx-auto sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16 lg:h-20">
                    ...
                    <div class="hidden lg:flex lg:items-center lg:justify-center lg:space-x-10">
                        <a href="#" title=""
                            class="text-base text-white transition-all duration-200 hover:text-opacity-80"> Features
                        </a>

                        <a href="#" title=""
                            class="text-base text-white transition-all duration-200 hover:text-opacity-80"> Solutions
                        </a>

                        <a href="#" title=""
                            class="text-base text-white transition-all duration-200 hover:text-opacity-80"> Resources
                        </a>

                        <a href="#" title=""
                            class="text-base text-white transition-all duration-200 hover:text-opacity-80"> Pricing </a>
                    </div>
        ...
        <section class="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24">
            <div class="absolute inset-x-0 bottom-0 z-10 hidden lg:flex">
                <img class="hidden w-full lg:block"
                    ...
                    alt="" />
                <img class="block w-full lg:hidden"
            ...
            <div class="relative z-20 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="max-w-xl mx-auto text-center">
                    <h1 class="text-4xl font-bold sm:text-6xl">
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white"> Simplified
                            credit cards for students </span>
                    </h1>
                    <p class="mt-5 text-base text-white sm:text-xl">No more hassle taking loans and making payments. Try
                    ...
                    <div class="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
                        <div class="flex items-center">
                            <svg class="flex-shrink-0" width="31" height="25" viewBox="0 0 31 25" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="#28CC9D" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                                ...
                                <path
                                    ...
                                    fill="#0B1715" stroke="white" stroke-width="1.5" stroke-miterlimit="10"
                        ...
                        <div class="flex items-center">
                            <svg class="flex-shrink-0" width="23" height="23" viewBox="0 0 23 23"
                        ...
                        <div class="flex items-center">
                            <svg class="flex-shrink-0" width="20" height="24" viewBox="0 0 20 24"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div class="px-4 mx-auto sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-16 lg:h-20">
                    ...
                    <div class="hidden lg:flex lg:items-center lg:justify-center lg:space-x-10">
                        ...
                        <a href="#" title=""
                            class="text-base text-white transition-all duration-200 hover:text-opacity-80"> Pricing
                        </a>
                    </div>
                ...
                <div class="max-w-xl mx-auto text-center">
                    <h1 class="text-4xl font-bold sm:text-6xl">
                        <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white">
                            Simplified credit cards for students </span>
                    </h1>
                    <p class="mt-5 text-base text-white sm:text-xl">No more hassle taking loans and making payments.
                        Try Postcrats credit card, make your life simple.</p>
