<x-guest-layout>
    <section
        ...
        <form action="#" class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
                <div class="flex-1 min-w-0 space-y-8">
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <label for="your_name" class="block mb-2 text-sm font-medium text-gray-900 "> Your name
                                </label>
                            ...
                            <div>
                                <label for="your_email" class="block mb-2 text-sm font-medium text-gray-900 "> Your
                                    email* </label>
                            ...
                            <div>
                                <label for="phone-input-3" class="block mb-2 text-sm font-medium text-gray-900 "> Phone
                                    Number* </label>
                                <div class="flex items-center">
                                    ...
                                    <div id="dropdown-phone-3"
                                        class="z-10 hidden w-56 bg-white divide-y divide-gray-100 rounded-lg shadow ">
                                        <ul class="p-2 text-sm font-medium text-gray-700 "
                                            aria-labelledby="dropdown-phone-button-2">
                                            <li>
                                                <button type="button"
                                                    class="inline-flex w-full px-3 py-2 text-sm text-gray-500 rounded-md hover:bg-gray-100 hover:text-gray-900"
                                                    role="menuitem">
                                    ...
                                    <div class="relative w-full">
                                        <input type="text" id="phone-input"
                                            class="z-20 block w-full rounded-e-lg border border-s-0 border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary focus:ring-primary"
                            ...
                            <div>
                                <label for="vat_number" class="block mb-2 text-sm font-medium text-gray-900 "> VAT
                                    number </label>
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                                ...
                                <div class="flex items-start">
                                    <div class="flex items-center h-5">
                                        <input id="credit-card" aria-describedby="credit-card-text" type="radio"
                                            ...
                                            class="w-4 h-4 bg-white border-gray-300 text-primary focus:ring-2 focus:ring-red-800"
                                            checked />
                                    </div>
                            ...
                            <div class="p-4 border border-gray-200 rounded-lg bg-gray-50 ps-4 ">
                                <div class="flex items-start">
                                    ...
                                    <div class="text-sm ms-4">
                                        <label for="paypal-2" class="font-medium leading-none text-gray-900 "> Paypal
                                            account </label>
                                        <p id="paypal-text" class="mt-1 text-xs font-normal text-gray-500 ">Connect to
                                            your account</p>
                                    </div>
                                </div>
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                            <div class="p-4 border border-gray-200 rounded-lg bg-gray-50 ps-4 ">
                                <div class="flex items-start">
                                    ...
                                    <div class="text-sm ms-4">
                                        <label for="dhl" class="font-medium leading-none text-gray-900 "> $15 -
                                            DHL Fast Delivery </label>
                                        <p id="dhl-text" class="mt-1 text-xs font-normal text-gray-500 ">Get it by
                                            Tommorow</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-4 border border-gray-200 rounded-lg bg-gray-50 ps-4 ">
                                <div class="flex items-start">
                                    ...
                                    <div class="text-sm ms-4">
                                        <label for="fedex" class="font-medium leading-none text-gray-900 "> Free
                                            Delivery - FedEx </label>
                                        <p id="fedex-text" class="mt-1 text-xs font-normal text-gray-500 ">Get it by
                            ...
                            <div class="p-4 border border-gray-200 rounded-lg bg-gray-50 ps-4 ">
                                <div class="flex items-start">
                                    ...
                                    <div class="text-sm ms-4">
                                        <label for="express" class="font-medium leading-none text-gray-900 "> $49 -
                                            Express Delivery </label>
                                        <p id="express-text" class="mt-1 text-xs font-normal text-gray-500 ">Get it
                                            today</p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        <label for="voucher" class="block mb-2 text-sm font-medium text-gray-900 "> Enter a gift
                        ...
                        <div class="flex items-center max-w-md gap-4">
                            ...
                            <button type="button"
                                class="flex items-center justify-center rounded-lg bg-primary px-5 py-2.5 text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300">Apply</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full mt-6 space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
                    ...
                    <div class="space-y-3">
                        <button type="submit"
                            class="flex w-full items-center justify-center rounded-lg bg-primary px-5 py-2.5 text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4  focus:ring-red-300">Proceed
                            to Payment</button>

                        <p class="text-sm font-normal text-gray-500 ">One or more items in your cart require an
                            account. <a href="#" title=""
                                class="font-medium underline text-primary-700 hover:no-underline">Sign in or create an
                                account now.</a>.</p>
                    </div>
                </div>
            </div>
