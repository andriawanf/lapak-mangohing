<x-guest-layout>
    <section
        class="relative lg:min-h-screen pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24 z-0 min-h-screen px-6 isolate lg:px-8 bg-[#F2F2F2] w-full">

        <div class="relative z-20 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="relative max-w-2xl mx-auto text-center">
                <div class="hidden lg:block">
                    <svg class="absolute top-0 z-10 rotate-180 translate-x-56 -translate-y-20 opacity-50 left-1/2"
                        width="130" height="130" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 100 125"
                        enable-background="new 0 0 100 100" xml:space="preserve">
                        <g fill="#f48c06">
                            <path
                                d="M70.9,73.7c-3.2-3.2-5.5-7-6.4-10.7c-0.6-2.4-0.6-4.6,0.1-6.4c-2.5,1.7-5.4,2.6-8.5,2.6c-8.4,0-15.3-6.8-15.3-15.3   c0-3.1,0.9-6,2.6-8.5c-0.9,0.3-2,0.5-3.1,0.5c-1,0-2.1-0.1-3.3-0.4c-3.7-0.9-7.5-3.2-10.7-6.4c-0.9-0.9-1.8-1.9-2.5-2.9   c-3.6,5.5-6.1,11.7-7.2,18.4c0,0.2-0.3,0.4-0.5,0.4c0,0-0.1,0-0.1,0c-0.3,0-0.5-0.3-0.4-0.6c1.2-6.9,3.7-13.4,7.5-19.1   c-1-1.5-1.8-3-2.5-4.5c-5.5,7.9-8.4,17.2-8.4,27c0,0.3-0.2,0.5-0.5,0.5s-0.5-0.2-0.5-0.5c0-10.2,3.1-20,9-28.2   c-0.1-0.4-0.3-0.9-0.4-1.3c-0.5-2-0.5-3.9-0.2-5.4C12.4,21.6,8.3,32.5,8.3,43.9c0,26.3,21.4,47.7,47.7,47.7c11.5,0,22.3-4,31-11.4   c-0.7,0.2-1.4,0.2-2.2,0.2C80.6,80.5,75.3,78.1,70.9,73.7z" />
                            <path
                                d="M27,28.4c3.1,3.1,6.7,5.3,10.2,6.2c3.4,0.8,6.3,0.3,8-1.4c1.8-1.8,2.3-4.6,1.4-8c-0.9-3.5-3.1-7.1-6.2-10.2   c-3.1-3.1-6.7-5.3-10.2-6.2c-1.1-0.3-2.1-0.4-3-0.4c-2.1,0-3.8,0.6-5,1.8c-1.8,1.8-2.3,4.6-1.4,8C21.8,21.7,23.9,25.3,27,28.4z    M23.7,11.6c0.8-0.8,2-1.2,3.6-1.2c3.6,0,8.2,2.3,11.8,6c2.8,2.8,4.9,6.2,5.6,9.3c0.7,2.7,0.3,4.9-0.9,6.1c-0.8,0.8-2,1.2-3.6,1.2   c-3.6,0-8.2-2.3-11.8-6c-2.8-2.8-4.9-6.2-5.6-9.3C22.2,15,22.5,12.8,23.7,11.6z" />
                            <path
                                d="M29.2,26.3c3.5,3.5,7.8,5.7,11.1,5.7c1.3,0,2.2-0.3,2.9-1c0.9-0.9,1.2-2.6,0.8-4.6l-3.2,3.2c-0.1,0.1-0.2,0.1-0.4,0.1   s-0.3,0-0.4-0.1c-0.2-0.2-0.2-0.5,0-0.7l3.3-3.3c0.1-0.1,0.2-0.1,0.3-0.1c-0.3-1.2-0.9-2.4-1.5-3.5l-1.8,1.8   c-0.1,0.1-0.2,0.1-0.4,0.1s-0.3,0-0.4-0.1c-0.2-0.2-0.2-0.5,0-0.7l1.9-1.9c-0.9-1.4-1.9-2.7-3.2-4c-3.5-3.5-7.8-5.7-11.1-5.7   c-1.3,0-2.2,0.3-2.9,1c-1,1-1.2,2.9-0.6,5.2C24.5,20.4,26.5,23.6,29.2,26.3z" />
                            <path
                                d="M85.1,59.4c-3.1-3.1-6.7-5.3-10.2-6.2c-1.1-0.3-2.1-0.4-3-0.4c-2.1,0-3.8,0.6-5,1.8c-1.8,1.8-2.3,4.6-1.4,8   c0.9,3.5,3.1,7.1,6.2,10.2c6.3,6.3,14.5,8.5,18.2,4.7C93.6,74,91.4,65.8,85.1,59.4z M88.4,76.3c-0.8,0.8-2,1.2-3.6,1.2   c-3.6,0-8.2-2.3-11.8-6c-2.8-2.8-4.9-6.2-5.6-9.3c-0.7-2.7-0.3-4.9,0.9-6.1c0.8-0.8,2-1.2,3.6-1.2c3.6,0,8.2,2.3,11.8,6   C89.7,66.9,91,73.7,88.4,76.3z" />
                            <path
                                d="M71.9,55.9c-1.3,0-2.2,0.3-2.9,1c-1,1-1.2,2.9-0.6,5.2c0.7,2.9,2.7,6.1,5.4,8.8c3.5,3.5,7.8,5.7,11.1,5.7   c1.3,0,2.2-0.3,2.9-0.9c2.2-2.2,0.6-8.6-4.7-14C79.5,58.1,75.2,55.9,71.9,55.9z" />
                        </g>
                    </svg>
                    <svg class="absolute top-0 z-10 opacity-50 translate-y-36 -translate-x-96 left-1/2" width="130"
                        height="130" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                ...
                <h1 class="text-5xl sm:text-7xl">
                    <span class="tracking-wide text-primary font-superFood"> Cemilan untuk semua kalangan </span>
                </h1>
                <p class="mt-5 text-base text-tertiary/65 sm:text-xl">Nikmati cemilan lezat untuk segala usia. Berbagai
                    varian rasa yang cocok dinikmati kapan saja.</p>

                <a href="#" title=""
                    class="inline-flex items-center px-6 py-4 mt-6 font-semibold text-white transition-all duration-200 rounded-full bg-primary sm:mt-12 hover:bg-red-800 focus:bg-red-800"
                    role="button">
                    Pre-order sekarang
            ...
            <div class="max-w-6xl mx-auto">
                <div class="grid grid-cols-1 px-20 mt-12 text-left gap-x-6 gap-y-8 sm:grid-cols-3 sm:px-0">
                    <div class="flex items-start gap-4">
                        <div class="p-2 border rounded-xl bg-primary/10 border-primary/25">
                            <i data-lucide="person-standing" class="flex-shrink-0 w-6 h-6 stroke-1 text-tertiary"></i>
                        </div>
                        <div>
                            <h3 class="text-base font-medium text-tertiary">Untuk Semua Usia</h3>
                            <p class="mt-1 text-sm text-tertiary/65">Cocok dinikmati oleh anak-anak hingga orang dewasa.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4">
                        <div class="p-2 border rounded-xl bg-primary/10 border-primary/25">
                            <i data-lucide="heart-handshake" class="flex-shrink-0 w-6 h-6 stroke-1 text-tertiary"></i>
                        </div>
                        <div>
                            <h3 class="text-base font-medium text-tertiary">Nikmati Untuk Setiap Kesempatan</h3>
                            <p class="mt-1 text-sm text-tertiary/65">Ideal untuk berbagai momen, dari santai hingga
                                acara
                                spesial.
                            </p>
                        </div>
                    ...
                    <div class="flex items-start gap-4">
                        <div class="p-2 border rounded-xl bg-primary/10 border-primary/25">
                            <i data-lucide="popcorn" class="flex-shrink-0 w-6 h-6 stroke-1 text-tertiary"></i>
                        </div>
                        <div>
                            <h3 class="text-base font-medium text-tertiary">Varian Rasa yang Lengkap</h3>
                            <p class="mt-1 text-sm text-tertiary/65">Beragam pilihan rasa untuk setiap selera.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section
        class="relative z-0 w-full min-h-screen px-6 pt-12 pb-5 lg:min-h-screen sm:pt-16 sm:pb-8 lg:pb-12 isolate lg:px-8 bg-primary food-pattern">
    </section>
                ...
                <div class="w-auto p-8">
                    <div class="-m-1.5 flex flex-wrap">
                        <div class="w-auto p-1.5">
                            <a href="#">
                                <div
                                    class="flex items-center justify-center w-8 h-8 border border-gray-300 rounded-full hover:border-gray-400">
