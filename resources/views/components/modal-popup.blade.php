        ...
        <div class="relative bg-white rounded-lg shadow">
            ...
            <div class="p-4 text-center md:p-5">
                ...
                <button data-modal-hide="popup-modal-{{ $id }}" type="button"
                    class="py-2.5 px-5 ms-3 text-sm font-medium text-tertiary focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:z-10 focus:ring-4 focus:ring-gray-100">No,
                    cancel</button>
            </div>
        </div>
    </div>
