<section
    class="relative z-0 w-full px-6 pt-12 pb-12 min-h-screen lg:min-h-screen lg:pt-16 lg:pb-16 isolate lg:px-8 bg-[#F2F2F2] food-pattern">
    <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
            <div class="grid gap-4 my-4 sm:grid-cols-2 md:my-8 lg:grid-cols-3 xl:grid-cols-4">
