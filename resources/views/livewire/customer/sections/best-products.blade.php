<section
    ...
    <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
        <h1 class="text-3xl tracking-wide text-center uppercase text-primary sm:text-5xl font-superFood">produk terbaik
            kami...
        </h1>
        <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
            <div class="grid gap-4 mt-4 sm:grid-cols-2 md:mt-8 lg:grid-cols-3 xl:grid-cols-4">
                <div class="p-6 bg-white border border-gray-200 shadow-sm rounded-3xl">
                    <div class="w-full h-56">
                        <a href="#">
                            <img class="h-full mx-auto" src="{{ asset('/images/mang-ohing-logo.png') }}" alt="" />
                        </a>
                    </div>
                    <div class="pt-6">
                        <div class="flex items-center justify-between gap-4 mb-4">
                            <span class="me-2 rounded bg-primary/15 px-2.5 py-0.5 text-xs font-medium text-primary ">
                                Up to 35% off </span>
