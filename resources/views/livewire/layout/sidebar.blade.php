        ...
        <div class="flex flex-col gap-2">
            ...
            <x-nav-link :href="route('dashboard.admin.products.list')" :active="request()->routeIs('dashboard.admin.products.list')" class="flex items-center justify-start gap-2">
                <i data-lucide="shopping-cart"
                    class="transition-all stroke-1 w-4 h-4 {{ request()->routeIs('dashboard.admin.products.list') ? 'stroke-tertiary' : 'stroke-white/80 group-hover:stroke-tertiary' }} "></i>
                <h1>Products</h1>
            </x-nav-link>
            <x-nav-link :href="route('dashboard.admin.categories')" :active="request()->routeIs('dashboard.admin.categories')" class="flex items-center justify-start gap-2">
                <i data-lucide="layout-list"
                    class="transition-all stroke-1 w-4 h-4 {{ request()->routeIs('dashboard.admin.categories') ? 'stroke-tertiary' : 'stroke-white/80 group-hover:stroke-tertiary' }} "></i>
                <h1>Categories</h1>
            </x-nav-link>
