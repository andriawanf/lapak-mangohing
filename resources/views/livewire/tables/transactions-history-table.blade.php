<div class="p-3 mx-3 my-6 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-6">
    ...
    <div class="items-center justify-between lg:flex">
        <div class="mb-4 lg:mb-0">
            <h3 class="mb-2 text-xl font-bold text-tertiary">Transactions</h3>
            <span class="text-base font-normal text-gray-500">This is a list of
                latest transactions</span>
        </div>
        <div class="items-center sm:flex">
            <div class="flex items-center">
                <button id="dropdownDefault" data-dropdown-toggle="dropdown"
                    class="mb-4 sm:mb-0 mr-4 inline-flex items-center text-tertiary bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-4 py-2.5"
                    type="button">
                    Filter by status
            ...
            <div date-rangepicker class="flex items-center space-x-4">
                <div class="relative">
                    ...
                    <input name="start" type="text"
                        class="bg-gray-50 border border-gray-300 text-tertiary text-sm rounded-lg focus:ring-primary focus:border-primary block w-full pl-10 p-2.5 "
                        placeholder="From">
                </div>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                        ...
                        <tbody class="bg-white text-tertiary">
                            <tr>
                                ...
                                <td class="p-4 whitespace-nowrap">
                                    <span
                                        class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-green-400">Paid</span>
                                </td>
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap ">
                                    Jl. Cempedak No. 1 Bandung
                                </td>
                                <td class="p-4 whitespace-nowrap">
                                    <span
                                        class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md border border-green-400 ">Completed</span>
                                </td>
